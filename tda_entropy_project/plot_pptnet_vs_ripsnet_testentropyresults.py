...
if dataset == "modelnet40":
    pptnet_json = Path(r"D:\GRE\PPT-Net\tda_entropy_project\outputs\modelnet40\train_entropy\best_test_metrics.json")
    ripsnet_json = Path(r"D:\GRE\PPT-Net\tda_entropy_project\outputs\ripsnet_results_mn40\best_test_metrics.json")
